...
export default function ListEventScreen({ navigation }) {
    ...
    return (
      <HStack flex="1" pl="2">
        <Pressable
          ...
          onPress={() =>
            navigation.navigate("Modifier un event", { data: data.item })
          }
          _pressed={{
            opacity: 0.5,
          }}
  ...
  const renderItem = ({ item, index }) => (
    <Box>
      <Pressable
        onPress={() => navigation.navigate("Afficher un event", { data: item })}
        _dark={{
          bg: "coolGray.800",
        }}
        _light={{
        ...
        >
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            <Box bg="white" safeArea flex="1">
              ...
              />
              <Fab
                onPress={() => navigation.navigate("Ajout d'un event")}
                shadow={2}
                size="md"
