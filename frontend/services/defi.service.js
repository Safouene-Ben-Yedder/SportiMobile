...
const API_URL = "http://192.168.1.21:8080/api/coach/defi/";
const API_URL_Player = "http://192.168.1.21:8080/api/joueur/defi/";
...
const defiDone = async (id) => {
  ...
  const result = await axios.put(
    `http://10.1.1.35:8080/api/joueur/defidone/${id}/${token}`
  );
  return result.data;
};
